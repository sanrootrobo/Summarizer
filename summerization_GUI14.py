...
class AdvancedScraperApp:
    ...
    def create_source_tab(self, parent):
        ...
        ttk.Radiobutton(mode_frame, text="🎬 YouTube Video (Multimodal Capability)", variable=self.input_mode_var, value="youtube_video", command=self.toggle_input_mode).pack(anchor=tk.W)
    ...
    def toggle_input_mode(self):
        ...
        if mode == "upload": self.research_checkbutton.config(state=tk.NORMAL)
        self.toggle_research_panel()
    ...
    def start_task_thread(self):
        ...
        mode = self.input_mode_var.get()
        if mode == "youtube_video": target_function = self.run_youtube_video_analysis
